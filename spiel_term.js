...
let derDieDasDes = [
    "Das Buch der Mann",
    "Die Blume der Garten",
    "Der Stuhl des Zimmer",
    "Die Jacke der Frau",
    "Das Fahrrad des Kindes",
    "Der Hund des Nachbarn",
    "Die Gitarre des Musikers",
    "Das Glas des Trinkers",
    "Der Apfel des Baumes",
    "Die Decke des Bettes",
    "Der Schrank des Schülers",
    "Das Auto des Fahrers",
    "Die Tür des Hauses",
    "Der Hut des Mannes",
    "Das Feuer des Ofens",
    "Die Katze der Besitzerin",
    "Der Kaffee des Morgen",
    "Die Schuhe der Läuferin",
    "Das Wasser des Sees",
    "Der Himmel des Abends",
    "Die Brille des Lesers",
    "Der Schirm des Regens",
    "Das Handy des Besitzers",
    "Die Kamera des Fotografen",
    "Der Wald des Spaziergangs",
    "Die Uhr des Wartens",
    "Das Papier des Schreibens",
    "Der Tee des Trinkens",
    "Die Lampe des Zimmers",
    "Der Vogel des Himmels",
    "Das Essen des Kochs",
    "Die Straße des Spaziergangs",
    "Der Brief des Schreibers",
    "Die Pizza des Abends",
    ...
    "Das Bild des Malers",
    "Die Sonne des Tages",
    "Der Kuchen des Bäckers",
    "Das Geschenk des Freundes",
    "Die Nadel des Nähers",
    "Der Wein des Abends",
    "Das Bett des Schlafens",
    "Die Rose des Gartens",
    "Der Fisch des Meeres",
    "Das Tier des Waldes",
    "Die Decke des Himmels",
    "Der Käse des Kühlschranks",
    "Das Radio des Hörers",
    "Die Waffe des Soldaten",
    "Der Film des Regisseurs",
    "Das Spielzeug des Kindes",
    "Die Wolke des Himmels",
    "Der Schnee des Winters",
    "Das Kabel des Verbindens",
    "Die Tasse des Kaffees",
    "Der Stift des Schreibers",
    "Das Haar des Kopfes",
    "Die Socke des Fußes",
    "Der Pullover des Mannes",
    "Das Messer des Kochs",
    "Die Brücke des Flusses",
    "Der Zahn des Mundes",
    "Das T-Shirt des Jugendlichen",
    "Die Zahnbürste des Morgens",
    "Der Löffel des Essens",
    "Das Boot des Sees",
    "Die Türklinke des Hauses",
    "Der Schatten des Baumes",
    "Das Poster des Zimmers",
    "Die Wand des Raumes",
    "Der Gartenschlauch des Bewässerers",
    "Das Handtuch des Bades",
    ...
    "Die Bluse der Frau",
    "Der Stift der Schülerin",
    "Die Schere des Friseurs",
    "Das Handy der Freundin",
    "Der Kaffee des Cafés",
    "Die Jeans des Teenagers",
    "Das Fahrrad des Radfahrers",
    "Die Tasche der Reisenden",
    "Der Koffer des Reisenden",
    "Die Sonnenbrille des Urlaubers",
    "Das Hemd des Mannes",
    "Der Regenschirm des Passanten",
    "Die Uhr des Juweliers",
    "Die Brille des Optikers",
    "Das Rad des Fahrrads",
    "Der Ball der Fußballspieler",
    "Die Schuhe des Athleten",
    "Das Tor des Fußballfeldes",
    "Die Uhr des Zugreisenden",
    "Der Schlüssel des Hauses",
    "Das Telefon des Anrufers",
    "Die Krawatte des Geschäftsmanns",
    "Die Tafel des Lehrers",
    "Der Pinsel des Malers",
    "Das Fahrgestell des Autos",
    "Der Kühlschrank des Küchenchefs",
    "Die Blätter des Baumes",
    "Das Mikrofon des Sängers",
    "Die Stimme des Sprechers",
    "Der Schuh des Läufers",
    "Das Gras des Gartens",
    "Der Zaun des Grundstücks",
    "Die Kette des Fahrrads",
    "Die Decke des Zeltes",
    "Der Flügel des Vogels",
    "Die Feder des Schreibers",
    "Das Laken des Bettes",
    "Der Teppich des Wohnzimmers",
    "Die Zähne des Lächelns",
    "Das Hörgerät des älteren Menschen",
    "Die Gitarrensaiten des Musikers",
    "Der Schmuck des Juweliers",
...
let javaScriptMethoden = {
    ...
    "RegExp-Methoden": ["compile()", "exec()", "test()", "toString()"],
    "Function-Methoden": ["apply()", "bind()", "call()", "toString()"],
    "Object-Methoden": [
        "assign()",
        "create()",
        "defineProperties()",
    ...
    "Promise-Methoden": ["all()", "race()", "reject()", "resolve()"],
    "Symbol-Methoden": ["for()", "keyFor()"],
    "Generator-Methoden": ["next()", "return()", "throw()"],
    "Reflect-Methoden": [
        "apply()",
        "construct()",
        "defineProperty()",
    ...
    "Iterator-Methoden": ["@@iterator", "next()"],
    "TypedArray-Methoden": [
        "copyWithin()",
        "entries()",
        "every()",
...
let javaScriptSympole = {
    "=": "(Zuweisungsoperator)(gleich-Operator)",
    "+": "(Additionsoperator oder Concatenation-Operator)",
    "-": "(Subtraktionsoperator oder Negationsoperator)",
    ...
    "!==": "(Strikte Ungleichheitsoperatoren)",
    ">": "(Größer-als-Operator)",
    "<": "(Kleiner-als-Operator)",
    "<=": "(Kleiner-als-oder-gleich-Operator)",
    "=>": "(Pfeilfunktion für verkürzte Funktionsdefinitionen)",
    "!": "(Negationsoperator)",
    "&&": "(Logischer Und-Operator)",
    "||": "(Logischer Oder-Operator)",
    "?": "(Ternärer Bedingungsoperator)",
    ":": "(Ternärer Bedingungsoperator)",
    ":O": "(Doppelpunkt für die Zuweisung von Eigenschaftswerten in Objektliteralen)",
    ".": "(Punkt-Operator für Eigenschaftszugriff und Methodenaufrufe)",
    "...": "(Spread-Operator für die Verbreitung von Arrays oder Objekten in Funktionen oder Array-Literalen)",
    "[]": "(Klammer-Operatoren für den Zugriff auf Array-Elemente und Objekteigenschaften mit dynamischen Schlüsseln)",
    "{}" : "(Geschweifte Klammern für die Definition von Objektliteralen und Codeblöcken)",
    "()": "(Runde Klammern für Funktionsaufrufe, Funktionsdefinitionen und Gruppierung von Ausdrücken)",
    ",": "(Komma-Operator für die Verkettung von Ausdrücken)",
    ";": "(Semikolon für die Trennung von Anweisungen)",
    "@": "(Dekorator-Operator für die Anwendung von Dekoratoren in Klassen oder Methoden)",
...
function eingabePru(B, L, S, F, N, H, P, T, Br, A, K, FaR, M, V, Sp) {
    // if (L.startsWith(B) &&länder2.includes(land[0].toUpperCase() + land.slice(1).toLowerCase())
    let punkte = 0;
    const inputLowerCase = B.toLowerCase();
    if (
        L &&
        L.toLowerCase().startsWith(inputLowerCase) &&
        länder2.join(",").toLowerCase().includes(L.toLowerCase())
    )
        punkte++;
    if (
        S &&
        S.toLowerCase().startsWith(inputLowerCase) &&
        statt.join(",").toLowerCase().includes(S.toLowerCase())
    )
        punkte++;
    if (
        F &&
        F.toLowerCase().startsWith(inputLowerCase) &&
        fluss.join(",").toLowerCase().includes(F.toLowerCase())
    )
        punkte++;
    if (
        N &&
    ...
    if (
        ...
        haussHallt.join(",").toLowerCase().includes(H.toLowerCase())
    )
        punkte++;
    if (
        P &&
        P.toLowerCase().startsWith(inputLowerCase) &&
        pflanzen.join(",").toLowerCase().includes(P.toLowerCase())
    )
        punkte++;
    if (
        T &&
        T.toLowerCase().startsWith(inputLowerCase) &&
        tiere.join(",").toLowerCase().includes(T.toLowerCase())
    )
        punkte++;
    if (
        Br &&
        Br.toLowerCase().startsWith(inputLowerCase) &&
        berufe.join(",").toLowerCase().includes(L.toLowerCase())
    )
        punkte++;
    if (
        A &&
    ...
    if (
        ...
        kleidungsnamen.join(",").toLowerCase().includes(K.toLowerCase())
    )
        punkte++;
    ...
    if (
        ...
        farbnamen.join(",").toLowerCase().includes(FaR.toLowerCase())
    )
        punkte++;
    if (
        M &&
        M.toLowerCase().startsWith(inputLowerCase) &&
        materialnamen.join(",").toLowerCase().includes(M.toLowerCase())
    )
        punkte++;
    if (
        V &&
        V.toLowerCase().startsWith(inputLowerCase) &&
        vierbDeu.join(",").toLowerCase().includes(V.toLowerCase())
    )
        punkte++;
    if (
        Sp &&
        Sp.toLowerCase().startsWith(inputLowerCase) &&
        sportarten.join(",").toLowerCase().includes(Sp.toLowerCase())
    )
        punkte++;
    return punkte;
}

// console.log(eingabePru("U", "Uruguay", "Ulaanbaatar"));
// Buchtabe,Land,Statt,Fluss,Name,Haushalt,Pflanzen,Tier,Auto,Kleidungstuk,Farbe,Matteriel,Verb,Sportart
  ...
  const L = prompt("LandNamme ");
  const S = prompt("StattNamme ");
  const F = prompt("FlussNamme ");
  const N = prompt("Namme ");
  const H = prompt("Haushalt ");
  const P = prompt("Pflanze ");
  const T = prompt("TiereNamme ");
  const Br = prompt("Beruf ");
  const A = prompt("Auto ");
  const K = prompt("Kleidung ");
  const Far = prompt("Fahrbe ");
  const M = prompt("Mtierial ");
  const V = prompt("Verb ");
const Sp = prompt("Sportart ");
